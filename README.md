...
but mostly it cleaned up duplicates, files nobody has touched in forver not the ones in "glacier" storage AKA tape at the time, so they were never really gone for goodface

In other owrds. You used to have to program your computer to do stuff like clean up. Now it does it for you. There is something nostalgic about building one for yourself in a langauge you lke (Go).
